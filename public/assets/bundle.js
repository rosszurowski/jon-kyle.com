 ...
 * Code Highlighting
 */
var codeEls = [].concat(_toConsumableArray(document.querySelectorAll('code')));
 ...
 * Homepage centering
 */
var homeRowEls = [].concat(_toConsumableArray(document.querySelectorAll('[data-row]')));
var alignments = ['left', 'center', 'right'];

homeRowEls.forEach(function (el) {
  var elId = el.getAttribute('data-row');
  var styleEl = document.createElement('style');
  var elLeft = Math.random() * 20;
  var elWidth = Math.random() * (20 - elLeft) + 80;
  var elAlign = alignments[Math.floor(Math.random() * alignments.length)];
